...
module.exports = class KarmoyAdapter extends BaseAdapter {
  ...
  async fetchAddressUUID(addressData) {
    // Slightly roundabout way to get data for lookup. It looks like it's possible to look up
